...
- **AI Copilot** — Bring your own key (Gemini, OpenAI, Anthropic) for context-aware analysis of your molecules
- **Interactive Pareto** — Click any point to select the molecule; Lipinski threshold lines on all scatter charts
- **Expandable cards** — Click a molecule in the sidebar to see all properties + copyable SMILES
